...
# conda activate itk && export PYTHONPATH=/media/medical/gasperp/projects/dissm/gasperp_functions:$PYTHONPATH && python /media/medical/gasperp/projects/dissm/analyse_dataset/hn1_pred_180/02_convert.py && conda deactivate
